...
rem ============================================================
rem  AV1 NVENC + grav1synth Film Grain - FINAL v7.3 Upload-Bake
...
cls
echo ============================================================
echo        AV1 NVENC + grav1synth Film Grain FINAL v7.3 Upload-Bake
echo ============================================================
echo.
...
echo.
echo [3/%TOTAL_STAGES%] Remuxing original audio / subtitles / attachments...
...
if "%ENABLE_UPLOAD_BAKE%"=="1" (
    ...
    echo.
    echo Decoder      : libdav1d / Film Grain ON
