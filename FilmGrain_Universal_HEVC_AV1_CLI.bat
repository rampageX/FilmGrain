...
rem ============================================================
rem  Universal Film Grain pipeline - CLI
rem
...
cls
echo ============================================================
echo       Universal Film Grain Pipeline - CLI
echo ============================================================
echo.
...
"%FFMPEG%" -hide_banner -stats -y -i "%TMP_GRAIN%" -i "%INPUT%" -map 0:v:0 %AV1_FINAL_REMUX_MAP% -map_metadata 1 -map_chapters 1 %AV1_FINAL_REMUX_CODEC% %AV1_FINAL_REMUX_EXTRA% "%OUTPUT%"
...
rem Normalize VFR and mathematically equivalent FFprobe fractions before
rem deciding whether they belong to the NTSC or integer cinema family.
